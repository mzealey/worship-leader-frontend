...
const RelatedSongs = ({ related_songs, lang }: { related_songs: SongShortData[]; lang: string }) => {
...
export const SongInfoSide = ({
    ...
    const change_domain = (path?: string) => (path || '').replace(/^https?:\/\/songs.(yasamkilisesi|worshipleaderapp).com/i, API_HOST);
